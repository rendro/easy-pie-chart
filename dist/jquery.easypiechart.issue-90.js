 ...
 * @version 2.1.5
 *
 * another contributor authored this plugin - solved #90
 * @author Guilherme Rempel de Oliveira <rempel.oliveira@gmail.com>
 *
 **/
...
var CanvasRenderer = function(el, options) {
	...
	var drawBackground = function(percent) {
		...
		if(options.trackColor) drawCircle(options.trackColor, options.lineWidth, percent, 1);
	};
